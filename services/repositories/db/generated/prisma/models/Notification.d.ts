...
export type NotificationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "orderId" | "userId" | "channel" | "status" | "subject" | "message" | "payload" | "createdAt" | "sentAt", ExtArgs["result"]["notification"]>;
