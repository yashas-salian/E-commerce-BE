...
export type PaymentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "orderId" | "amount" | "currency" | "status" | "provider" | "transactionRef" | "meta" | "createdAt" | "updatedAt", ExtArgs["result"]["payment"]>;
